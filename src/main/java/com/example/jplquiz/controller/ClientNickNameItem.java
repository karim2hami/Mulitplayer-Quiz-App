...
/**
 * @author karimtouhami ClientNichNameItem: Controller Class for Textitem, that is displayed on the
 *     server-clientDashboard.fxml when a new Client enters the game.
 */
